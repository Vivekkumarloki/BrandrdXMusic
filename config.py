...
OWNER_ID = int(getenv("OWNER_ID", "6886985805"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Vivekkumarloki/BrandrdXMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BeatFlowCommunity")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/BeatXFlowSupport")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/8m0yvz.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/8m0yvz.jpg"
)
